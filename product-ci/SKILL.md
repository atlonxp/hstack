...
version: 1.0.0
description: |
  [UX Pipeline] Derive brand values from the product and map them to design tokens
  (colors, typography, motion, spacing). Values come from what users must FEEL to act
  ...
  or /discover-personas has produced product intel. (gstack)
