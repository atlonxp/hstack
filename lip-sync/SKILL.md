...
preamble-tier: 2
version: 1.0.0
description: "[Avatar & Embodiment] Lip-sync model selection + training/inference pipeline designer. (gstack)"
triggers:
  - lip-sync design
...
Picks the right backbone (Wav2Lip / SadTalker / MuseTalk / EMO /
...
"talking-head pipeline", or "audio-driven mouth animation".
