...
version: 1.0.0
description: |
  [Mobile] Mobile feature scaffolding across React Native, Flutter, native iOS (Swift), and
  native Android (Kotlin). Auto-detects the project's stack, generates a feature scaffold
  ...
  "Flutter feature", "iOS screen", "Android screen", or "new mobile feature". (gstack)
allowed-tools:
  - Read
  - Write
  - Edit
