...
preamble-tier: 2
version: 1.0.0
description: "[Intelligence & Memory] Keep gbrain current with this repo's code and refresh agent search guidance in CLAUDE.md. Wraps the gstack-gbrain-sync (gstack)"
triggers:
  - sync gbrain
  - refresh gbrain
  - reindex repo
