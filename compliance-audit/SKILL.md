...
preamble-tier: 2
version: 1.0.0
description: "[CISO Compliance + IR] Framework-aware compliance audit (SOC 2 Type II / ISO 27001 / HIPAA / PCI-DSS v4 / GDPR / CCPA). (gstack)"
allowed-tools:
  - Bash
  - Read
  - Grep
...
Walks each control with the framework citation,
...
"ISO 27001 control walk", "PCI-DSS assessment", "GDPR readiness", "POA&M".
