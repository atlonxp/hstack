...
preamble-tier: 4
version: 1.0.0
description: "[UX Audit] Persona-driven UX workflow audit on a live site. (gstack)"
allowed-tools:
  - Bash
  - Read
  - Write
...
Defines personas, scripts their
...
multiple user roles or multi-step workflows.
...
```bash
~/.claude/skills/gstack/bin/gstack-question-log '{"skill":"ux-audit","question_id":"<id>","question_summary":"<short>","category":"<approval|clarification|routing|cherry-pick|feedback-loop>","door_type":"<one-way|two-way>","options_count":N,"user_choice":"<key>","recommended":"<key>","session_id":"'"$_SESSION_ID"'"}' 2>/dev/null || true
```
