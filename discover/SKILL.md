...
name: discover
version: 1.0.0
description: "[CTO Discovery] CTO-mode technology and product intelligence for gstack."
allowed-tools:
  - Read
  - Grep
  - Glob
...
```bash
~/.claude/skills/gstack/bin/gstack-question-log '{"skill":"discover","question_id":"<id>","question_summary":"<short>","category":"<approval|clarification|routing|cherry-pick|feedback-loop>","door_type":"<one-way|two-way>","options_count":N,"user_choice":"<key>","recommended":"<key>","session_id":"'"$_SESSION_ID"'"}' 2>/dev/null || true
```
