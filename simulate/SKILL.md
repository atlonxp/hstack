...
version: 1.0.0
description: |
  [Operations Research / Behavioral] Build a discrete-event or Monte-Carlo simulation
  of a system from a description. Auto-generates a SimPy (or simmer) model, runs
  ...
  p99 look like", "tornado plot", "SimPy / simmer / discrete-event sim". (gstack)
allowed-tools:
  - Read
  - Write
  - Grep
