...
version: 1.0.0
description: |
  [Operations Research / Behavioral] Design a behavioral A/B / multi-arm experiment with
  proper power analysis, randomization strategy, primary + guardrail metrics, **pre-
  registered analysis plan** (anti p-hacking), and pre-committed success / failure
  decision rule. Cites the underlying behavioral principle being tested (anchoring,
  ...
  analysis", "pre-registration", "anti p-hacking experiment design". (gstack)
allowed-tools:
  - Read
  - Write
  - Grep
