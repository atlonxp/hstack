...
version: 1.0.0
description: |
  [Product Transposition] Document YOUR built thing as a reproducible cookbook:
  INGREDIENTS.md, STEPS.md, TECHNIQUES.md, PLATING.md. Four output modes via
  `--for {paper, blog, onboarding, replay}`. Works on transposed projects
