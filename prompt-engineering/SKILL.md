...
preamble-tier: 2
version: 1.0.0
description: "[AI Engineering / Research] Systematic prompt engineering: from a task spec, generates 6-8 prompt variants spanning CoT / few-shot / role-play / structured-output / decomposition / self-critique,... (gstack)"
triggers:
  - prompt engineering
  - prompt variants
  - prompt evaluation
...
break at scale", "pick the best prompt".
...
for variant in $(find prompts/{task}/variants -name '*.md' 2>/dev/null); do
